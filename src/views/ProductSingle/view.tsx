        ...
        <div className="flex flex-col gap-[20px]">
          <div className="grid grid-cols-2 gap-[20px]">
            <div className="w-full flex gap-[10px] max-h-[300px] xl:max-h-[470px] lg:max-h-[370px]">
              ...
              >
                {data?.map((i, idx: number) => (
                  <SwiperSlide
                    className="bg-[#efefef] cursor-pointer"
                    key={idx}
                  >
                    <img
                      src={`${i.location}`}
            ...
            <div className="flex flex-col gap-[24px]">
              <div className="flex flex-col gap-[12px]">
                ...
                <h1 className="text-mainBlack font-[500] text-[24px]">
                  Сковорода антипригарная Elegant, с крышкой, гранитное
                  покрытие, 24, 26, 28 см
                </h1>
                <p className="text-gray text-[12px] font-[500]">
                  Осталось: 12 штук
                </p>
          ...
          <div className="border border-line p-[24px] rounded-[16px] flex flex-col gap-[32px] items-start">
            <div className="flex flex-col gap-[8px] items-start">
              <h3 className="text-mainBlack text-[16px] font-semibold">
                Описание
              </h3>
              <p
              ...
              >
                ...
                semper arcu diam platea dictum magna. Scelerisque nisi molestie
                eget dignissim. Fusce ac malesuada elementum orci adipiscing.
                Lobortis amet id sollicitudin augue risus non. Eget sit arcu
                dignissim gravida sit faucibus tortor felis. Diam varius viverra
                nunc amet magna tellus sed accumsan convallis. Amet nulla
                viverra gravida dignissim semper massa. Maecenas et orci
                convallis amet nibh. Quisque tortor enim condimentum faucibus
                gravida. Morbi magna id nullam et felis. Lectus fringilla eget
                vestibulum tellus in ultrices condimentum faucibus gravida.
                Morbi magna id nullam nulla viverra gravida. Morbi magna id
                nullam et felis. Lectus fringilla eget vestibulum tellus in
                ultrices condimentum faucibus gravida. Morbi magna id nullam
                nulla viverra gravida. Morbi magna id nullam et felis. Lectus
                fringilla eget vestibulum tellus in ultrices condimentum
                faucibus gravida. Morbi magna id nullam nulla viverra
              </p>
              <button
            ...
            <button className="p-[11px_16px] text-[14px] font-medium text-white rounded-[6px] bg-[#03a5a5]">
              Все характеристики
            </button>
          </div>
        </div>
